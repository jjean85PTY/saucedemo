...
// This script is working, including LoginDemo.feature	 
	...
	public void user_enters_username_and_passowrd() throws InterruptedException {
		
		driver.findElement(By.id("name")).sendKeys("jaick");
...
//Without Page Object Model | Step by Step